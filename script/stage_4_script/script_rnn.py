...
from code_src.stage_4_code.Result_Saver import Result_Saver
from code_src.stage_4_code.Setting_KFold_CV import Setting_KFold_CV
from code_src.stage_4_code.Evaluate_Accuracy import Evaluate_Accuracy
import numpy as np
import torch
...
if 1:
    ...
    # training set
    train_data_obj = Dataset_Loader('IMDB', 'Movie Review')
    train_data_obj.dataset_source_folder_path = '../../data/stage_4_data/text_classification/0_toy_dataset/train'
    train_data_obj.load()
    # testing set
    test_data_obj = Dataset_Loader('IMDB', 'Movie Review Test')
    test_data_obj.dataset_source_folder_path = '../../data/stage_4_data/text_classification/0_toy_dataset/test'
    test_data_obj.load()



    method_obj = Method_RNN('Recurrent Neuron Network', '', train_data_obj.vocab_size)
    #
